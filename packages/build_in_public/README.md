...
The Remotion-based build-in-public video generator that used to live here has moved to its own repo: **[prompt2video](https://github.com/jeromeetienne/prompt2video)**. See that repo for scaffolding a Remotion project and streaming Claude Code to produce an MP4 + slides PDF.
